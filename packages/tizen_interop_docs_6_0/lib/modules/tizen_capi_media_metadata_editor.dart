...
/// Module-scoped documentation wrappers for `tizenCapiMediaMetadataEditor`.
///
/// Tizen version: `6.0`.
/// Shared object(s): `libcapi-media-metadata-editor.so`.
///
/// Multimedia / Metadata Editor.
///
/// Generated from `package:tizen_interop` bindings and symbol maps.
library tizen_6_0_tizen_capi_media_metadata_editor;
...
/// Parameter picture_path The path of picture for adding to the metadata
...
///
/// Module getter: `tizenCapiMediaMetadataEditor`.
int metadata_editor_append_picture(
  metadata_editor_h metadata,
  ffi.Pointer<ffi.Char> picture_path,
) =>
    tizenCapiMediaMetadataEditor.metadata_editor_append_picture(
      metadata,
      picture_path,
    );
...
int metadata_editor_create(
  ffi.Pointer<metadata_editor_h> metadata,
    ...
    tizenCapiMediaMetadataEditor.metadata_editor_create(
      metadata,
    );
...
int metadata_editor_destroy(
  metadata_editor_h metadata,
    ...
    tizenCapiMediaMetadataEditor.metadata_editor_destroy(
      metadata,
    );
...
///
/// Parameter metadata The handle to metadata
/// Parameter attribute key attribute name to get
...
int metadata_editor_get_metadata(
  ...
  ffi.Pointer<ffi.Pointer<ffi.Char>> value,
    ...
    tizenCapiMediaMetadataEditor.metadata_editor_get_metadata(
      metadata,
      attribute,
      value,
    );
...
///
/// Parameter metadata The handle to metadata
/// Parameter index picture order (starts with 0)
/// Output parameter picture encoded picture
/// Output parameter size encoded picture size
/// Output parameter mime_type the MIME of the picture
/// @return 0 on success, otherwise a negative error value
/// @retval #METADATA_EDITOR_ERROR_NONE Successful
/// @retval #METADATA_EDITOR_ERROR_INVALID_PARAMETER Invalid parameter
/// @retval #METADATA_EDITOR_ERROR_OUT_OF_MEMORY Out of memory
...
int metadata_editor_get_picture(
  ...
  ffi.Pointer<ffi.Pointer<ffi.Char>> mime_type,
    ...
    tizenCapiMediaMetadataEditor.metadata_editor_get_picture(
      metadata,
      index,
      picture,
      size,
...
///
/// Parameter metadata The handle to metadata
/// Parameter index artwork image order
/// @return 0 on success, otherwise a negative error value
/// @retval #METADATA_EDITOR_ERROR_NONE Successful
/// @retval #METADATA_EDITOR_ERROR_INVALID_PARAMETER Invalid parameter
/// @retval #METADATA_EDITOR_ERROR_OUT_OF_MEMORY Out of memory
...
int metadata_editor_remove_picture(
  ...
  int index,
    ...
    tizenCapiMediaMetadataEditor.metadata_editor_remove_picture(
      metadata,
      index,
    );
...
int metadata_editor_set_metadata(
  ...
  ffi.Pointer<ffi.Char> value,
    ...
    tizenCapiMediaMetadataEditor.metadata_editor_set_metadata(
      metadata,
      attribute,
      value,
    );
...
///
/// Parameter metadata The handle to metadata
/// Parameter path path to read or write metadata
/// @return 0 on success, otherwise a negative error value
/// @retval #METADATA_EDITOR_ERROR_NONE Successful
/// @retval #METADATA_EDITOR_ERROR_INVALID_PARAMETER Invalid parameter
...
int metadata_editor_set_path(
  ...
  ffi.Pointer<ffi.Char> path,
    ...
    tizenCapiMediaMetadataEditor.metadata_editor_set_path(
      metadata,
      path,
    );
...
int metadata_editor_update_metadata(
  metadata_editor_h metadata,
    ...
    tizenCapiMediaMetadataEditor.metadata_editor_update_metadata(
      metadata,
    );
