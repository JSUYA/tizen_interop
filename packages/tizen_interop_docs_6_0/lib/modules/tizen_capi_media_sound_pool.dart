...
/// Module-scoped documentation wrappers for `tizenCapiMediaSoundPool`.
///
/// Tizen version: `6.0`.
/// Shared object(s): `libcapi-media-sound-pool.so.0`.
///
/// Multimedia / Sound Pool.
///
/// Generated from `package:tizen_interop` bindings and symbol maps.
library tizen_6_0_tizen_capi_media_sound_pool;
...
/// remain their state.
///
/// Parameter  pool     The sound pool handle
...
///
/// Module getter: `tizenCapiMediaSoundPool`.
int sound_pool_activate(
  sound_pool_h pool,
) =>
    tizenCapiMediaSoundPool.sound_pool_activate(
      pool,
    );
...
///
/// Output parameter pool    The created sound pool handle
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE Successful
...
int sound_pool_create(
  ffi.Pointer<sound_pool_h> pool,
    ...
    tizenCapiMediaSoundPool.sound_pool_create(
      pool,
    );
...
int sound_pool_deactivate(
  sound_pool_h pool,
    ...
    tizenCapiMediaSoundPool.sound_pool_deactivate(
      pool,
    );
...
/// Parameter  pool     The sound pool handle will be destroyed
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER
...
int sound_pool_destroy(
  sound_pool_h pool,
    ...
    tizenCapiMediaSoundPool.sound_pool_destroy(
      pool,
    );
...
/// @since_tizen 4.0
/// Parameter  pool     The sound pool handle
/// Output parameter state    Current state of @a pool
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE              Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER
...
int sound_pool_get_state(
  ...
  ffi.Pointer<ffi.Int32> state,
    ...
    tizenCapiMediaSoundPool.sound_pool_get_state(
      pool,
      state,
    );
...
/// @since_tizen 4.0
/// Parameter   pool      The sound pool handle
/// Output parameter  volume    Pool global volume in 0.0~1.0 range
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE              Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER Invalid parameter
...
int sound_pool_get_volume(
  ...
  ffi.Pointer<ffi.Float> volume,
    ...
    tizenCapiMediaSoundPool.sound_pool_get_volume(
      pool,
      volume,
    );
...
///
/// Parameter  pool         The sound pool handle
/// Parameter  file_name    The name of the file that contains sound data
/// Parameter  tag          Unique string that will be used to identify source
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE              Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER
...
int sound_pool_load_source_from_file(
  ...
  ffi.Pointer<ffi.Char> tag,
    ...
    tizenCapiMediaSoundPool.sound_pool_load_source_from_file(
      pool,
      file_name,
      tag,
    );
...
/// @since_tizen 4.0
/// Parameter  pool        The sound pool handle
/// Parameter  callback    The callback that will be called after pool state
/// will be changed.  @a callback will be called
/// synchronously
/// Parameter  user_data   The user data to be passed to the @a callback
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE              Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER Invalid parameter
...
int sound_pool_set_state_changed_cb(
  ...
  ffi.Pointer<ffi.Void> user_data,
    ...
    tizenCapiMediaSoundPool.sound_pool_set_state_changed_cb(
      pool,
      callback,
      user_data,
    );
...
/// @since_tizen 4.0
/// Parameter  pool      The sound pool handle
/// Parameter  volume    Pool global volume in 0.0~1.0 range
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE              Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER Invalid parameter
...
int sound_pool_set_volume(
  ...
  double volume,
    ...
    tizenCapiMediaSoundPool.sound_pool_set_volume(
      pool,
      volume,
    );
...
/// Output parameter  priority    Stream priority (0 = lowest priority). Check
...
int sound_pool_stream_get_priority(
  ...
  ffi.Pointer<ffi.UnsignedInt> priority,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_get_priority(
      pool,
      id,
      priority,
    );
...
/// Parameter  pool     The sound pool handle
/// Parameter  id       Unique stream identifier
/// Output parameter state    Current state of stream
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE              Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER Invalid parameter
...
int sound_pool_stream_get_state(
  ...
  ffi.Pointer<ffi.Int32> state,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_get_state(
      pool,
      id,
      state,
    );
...
/// Parameter  pool      The sound pool handle
/// Parameter  id        Unique stream identifier
/// Output parameter volume    Stream volume in 0.0~1.0 range
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE              Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER Invalid parameter
/// (@a pool is NULL or corrupted, or @a volume is NULL)
...
int sound_pool_stream_get_volume(
  ...
  ffi.Pointer<ffi.Float> volume,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_get_volume(
      pool,
      id,
      volume,
    );
...
int sound_pool_stream_pause(
  ...
  int id,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_pause(
      pool,
      id,
    );
...
///
/// Parameter  pool        The sound pool handle
/// Parameter  tag         Unique string that identifies source
/// Parameter  loop        Number of times stream will be repeated
/// (pass 0 if stream should be repeated continuously)
/// Parameter  volume      Stream volume in 0.0~1.0 range
/// Parameter  priority    Stream priority (0 = lowest priority). Check
/// sound_pool_stream_set_priority() documentation
/// for details on prioritization rules.
/// Parameter  priority_policy    Stream priority policy.\n
...
/// Parameter  callback    The callback that will be called after stream state
/// will be changed, or NULL if this callback call
/// isn't needed. If @a callback is set, then it will
/// be called asynchronously.
/// Parameter  user_data   The user data to be passed to the @a callback
/// Output parameter id          Unique stream identifier that can be used to
...
int sound_pool_stream_play(
  ...
  ffi.Pointer<ffi.UnsignedInt> id,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_play(
      pool,
      tag,
      loop,
      volume,
...
int sound_pool_stream_resume(
  ...
  int id,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_resume(
      pool,
      id,
    );
...
/// Parameter  pool        The sound pool handle
/// Parameter  id          Unique stream identifier
/// Parameter  priority    Stream priority (0 = lowest priority)
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE              Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER Invalid parameter
/// (@a pool is NULL or corrupted)
...
int sound_pool_stream_set_priority(
  ...
  int priority,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_set_priority(
      pool,
      id,
      priority,
    );
...
int sound_pool_stream_set_volume(
  ...
  double volume,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_set_volume(
      pool,
      id,
      volume,
    );
...
int sound_pool_stream_stop(
  ...
  int id,
    ...
    tizenCapiMediaSoundPool.sound_pool_stream_stop(
      pool,
      id,
    );
...
///
/// Parameter  pool    The sound pool handle
/// Parameter  tag     Unique string that identifies the source
/// @return @c 0 on success, otherwise a negative error value
/// @retval #SOUND_POOL_ERROR_NONE Successful
/// @retval #SOUND_POOL_ERROR_INVALID_PARAMETER
/// Invalid parameter (@a pool is NULL or corrupted, @a tag is NULL)
...
int sound_pool_unload_source(
  ...
  ffi.Pointer<ffi.Char> tag,
    ...
    tizenCapiMediaSoundPool.sound_pool_unload_source(
      pool,
      tag,
    );
...
int sound_pool_unset_state_changed_cb(
  sound_pool_h pool,
    ...
    tizenCapiMediaSoundPool.sound_pool_unset_state_changed_cb(
      pool,
    );
