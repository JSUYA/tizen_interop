...
class Tizen90MvObjectDetection {
  ...
  late final _mv_face_detection_inferencePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_face_detection_h,
              imp1.mv_source_h)>>('mv_face_detection_inference');
  late final _mv_face_detection_inference = _mv_face_detection_inferencePtr
      .asFunction<int Function(mv_face_detection_h, imp1.mv_source_h)>();
  ...
  late final _mv_face_detection_inference_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_face_detection_h,
              imp1.mv_source_h)>>('mv_face_detection_inference_async');
  late final _mv_face_detection_inference_async =
      _mv_face_detection_inference_asyncPtr
          .asFunction<int Function(mv_face_detection_h, imp1.mv_source_h)>();
  ...
  late final _mv_object_detection_inferencePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_object_detection_h,
              imp1.mv_source_h)>>('mv_object_detection_inference');
  late final _mv_object_detection_inference = _mv_object_detection_inferencePtr
      .asFunction<int Function(mv_object_detection_h, imp1.mv_source_h)>();
  ...
  late final _mv_object_detection_inference_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_object_detection_h,
              imp1.mv_source_h)>>('mv_object_detection_inference_async');
  late final _mv_object_detection_inference_async =
      _mv_object_detection_inference_asyncPtr
          .asFunction<int Function(mv_object_detection_h, imp1.mv_source_h)>();
