...
class Tizen90CapiNnstreamer {
  ...
  late final _ml_pipeline_src_get_tensors_infoPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  ml_pipeline_src_h, ffi.Pointer<imp1.ml_tensors_info_h>)>>(
  ...
  int ml_pipeline_custom_easy_filter_register(
    ffi.Pointer<ffi.Char> name,
    imp1.ml_tensors_info_h in1,
    imp1.ml_tensors_info_h out,
...
typedef ml_custom_easy_invoke_cbFunction = ffi.Int Function(
    imp1.ml_tensors_data_h in1,
    imp1.ml_tensors_data_h out,
    ffi.Pointer<ffi.Void> user_data);
/// @nodoc
