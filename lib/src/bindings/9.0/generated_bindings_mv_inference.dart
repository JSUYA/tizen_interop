...
class Tizen90MvInference {
  ...
  late final _mv_inference_configurePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_inference_h,
              imp1.mv_engine_config_h)>>('mv_inference_configure');
  late final _mv_inference_configure = _mv_inference_configurePtr
      .asFunction<int Function(mv_inference_h, imp1.mv_engine_config_h)>();
  ...
  late final _mv_inference_object_detect =
      _mv_inference_object_detectPtr.asFunction<
          int Function(imp1.mv_source_h, mv_inference_h,
...
/// - 2.4
/// @nodoc
typedef mv_point_s = imp1.mv_point_s;
