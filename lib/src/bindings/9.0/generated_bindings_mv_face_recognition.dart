...
class Tizen90MvFaceRecognition {
  ...
  late final _mv_face_recognition_registerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_face_recognition_h, imp1.mv_source_h,
  ...
  late final _mv_face_recognition_register =
      _mv_face_recognition_registerPtr.asFunction<
          int Function(mv_face_recognition_h, imp1.mv_source_h,
  ...
  late final _mv_face_recognition_inferencePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_face_recognition_h,
              imp1.mv_source_h)>>('mv_face_recognition_inference');
  late final _mv_face_recognition_inference = _mv_face_recognition_inferencePtr
      .asFunction<int Function(mv_face_recognition_h, imp1.mv_source_h)>();
