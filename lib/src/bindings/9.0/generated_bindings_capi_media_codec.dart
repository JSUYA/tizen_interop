...
import 'generated_bindings_capi_media_tool.dart' as imp1;
...
class Tizen90CapiMediaCodec {
  ...
  late final _mediacodec_configure_from_media_formatPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mediacodec_h, imp1.media_format_h,
  ...
  late final _mediacodec_configure_from_media_format =
      _mediacodec_configure_from_media_formatPtr
          .asFunction<int Function(mediacodec_h, imp1.media_format_h, int)>();
  ...
  late final _mediacodec_process_inputPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mediacodec_h, imp1.media_packet_h,
              ffi.Uint64)>>('mediacodec_process_input');
  late final _mediacodec_process_input = _mediacodec_process_inputPtr
      .asFunction<int Function(mediacodec_h, imp1.media_packet_h, int)>();
  ...
  int mediacodec_get_output(
    mediacodec_h mediacodec,
    ffi.Pointer<imp1.media_packet_h> packet,
    int timeOutUs,
  ) {
  ...
  late final _mediacodec_get_outputPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mediacodec_h, ffi.Pointer<imp1.media_packet_h>,
              ffi.Uint64)>>('mediacodec_get_output');
  late final _mediacodec_get_output = _mediacodec_get_outputPtr.asFunction<
      int Function(mediacodec_h, ffi.Pointer<imp1.media_packet_h>, int)>();
  ...
  int mediacodec_get_packet_pool(
    mediacodec_h mediacodec,
    ffi.Pointer<imp1.media_packet_pool_h> pool,
  ) {
  ...
  late final _mediacodec_get_packet_poolPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  mediacodec_h, ffi.Pointer<imp1.media_packet_pool_h>)>>(
      'mediacodec_get_packet_pool');
  late final _mediacodec_get_packet_pool =
      _mediacodec_get_packet_poolPtr.asFunction<
          int Function(mediacodec_h, ffi.Pointer<imp1.media_packet_pool_h>)>();
}
...
typedef mediacodec_input_buffer_used_cbFunction = ffi.Void Function(
    imp1.media_packet_h packet, ffi.Pointer<ffi.Void> user_data);
/// @nodoc
