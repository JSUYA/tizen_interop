...
class Tizen90CapiMediaImageUtil {
  ...
  late final _image_util_transform_run =
      _image_util_transform_runPtr.asFunction<
          int Function(transformation_h, imp1.media_packet_h,
  ...
  int image_util_create_image_from_media_packet(
    imp1.media_packet_h media_packet,
    ffi.Pointer<image_util_image_h> image,
  ) {
  ...
  late final _image_util_create_image_from_media_packetPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  imp1.media_packet_h, ffi.Pointer<image_util_image_h>)>>(
  ...
  late final _image_util_create_image_from_media_packet =
      _image_util_create_image_from_media_packetPtr.asFunction<
          int Function(imp1.media_packet_h, ffi.Pointer<image_util_image_h>)>();
...
typedef image_util_transform_completed_cbFunction = ffi.Void Function(
    ffi.Pointer<imp1.media_packet_h> dst,
    ffi.Int error_code,
    ffi.Pointer<ffi.Void> user_data);
/// @nodoc
