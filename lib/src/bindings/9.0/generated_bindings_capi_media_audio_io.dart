...
class Tizen90CapiMediaAudioIo {
  ...
  late final _audio_in_set_sound_stream_infoPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(audio_in_h,
              imp1.sound_stream_info_h)>>('audio_in_set_sound_stream_info');
  late final _audio_in_set_sound_stream_info =
      _audio_in_set_sound_stream_infoPtr
          .asFunction<int Function(audio_in_h, imp1.sound_stream_info_h)>();
  ...
  late final _audio_out_set_sound_stream_infoPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(audio_out_h,
              imp1.sound_stream_info_h)>>('audio_out_set_sound_stream_info');
  late final _audio_out_set_sound_stream_info =
      _audio_out_set_sound_stream_infoPtr
          .asFunction<int Function(audio_out_h, imp1.sound_stream_info_h)>();
