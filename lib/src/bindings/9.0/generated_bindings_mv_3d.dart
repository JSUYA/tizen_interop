...
import 'generated_bindings_mv_common.dart' as imp1;
...
class Tizen90Mv3d {
  ...
  int mv_3d_configure(
    mv_3d_h mv3d,
    imp1.mv_engine_config_h engine_config,
  ) {
  ...
  late final _mv_3d_configurePtr = _lookup<
          ffi
          .NativeFunction<ffi.Int Function(mv_3d_h, imp1.mv_engine_config_h)>>(
      'mv_3d_configure');
  late final _mv_3d_configure = _mv_3d_configurePtr
      .asFunction<int Function(mv_3d_h, imp1.mv_engine_config_h)>();
  ...
  int mv_3d_run(
    mv_3d_h mv3d,
    imp1.mv_source_h source,
    imp1.mv_source_h source_extra,
    imp1.mv_source_h color,
  ) {
    return _mv_3d_run(
      mv3d,
      source,
  ...
  late final _mv_3d_runPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_3d_h, imp1.mv_source_h, imp1.mv_source_h,
              imp1.mv_source_h)>>('mv_3d_run');
  late final _mv_3d_run = _mv_3d_runPtr.asFunction<
      int Function(
          mv_3d_h, imp1.mv_source_h, imp1.mv_source_h, imp1.mv_source_h)>();
  ...
  late final _mv_3d_run_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_3d_h, imp1.mv_source_h, imp1.mv_source_h,
              imp1.mv_source_h)>>('mv_3d_run_async');
...
/// @nodoc
typedef mv_3d_pointcloud_cbFunction = ffi.Void Function(imp1.mv_source_h source,
    mv_3d_pointcloud_h pointcloud, ffi.Pointer<ffi.Void> user_data);
/// @nodoc
typedef Dartmv_3d_pointcloud_cbFunction = void Function(imp1.mv_source_h source,
    mv_3d_pointcloud_h pointcloud, ffi.Pointer<ffi.Void> user_data);
