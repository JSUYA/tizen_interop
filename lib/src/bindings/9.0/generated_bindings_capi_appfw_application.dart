...
import 'generated_bindings_capi_appfw_app_common.dart' as imp2;
...
class Tizen90CapiAppfwApplication {
  ...
  int ui_app_add_event_handler(
    ffi.Pointer<imp2.app_event_handler_h> event_handler,
    int event_type,
    imp2.app_event_cb callback,
    ffi.Pointer<ffi.Void> user_data,
  ) {
  ...
  late final _ui_app_add_event_handlerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<imp2.app_event_handler_h>,
              ffi.Int32,
              imp2.app_event_cb,
              ffi.Pointer<ffi.Void>)>>('ui_app_add_event_handler');
  late final _ui_app_add_event_handler =
      _ui_app_add_event_handlerPtr.asFunction<
          int Function(ffi.Pointer<imp2.app_event_handler_h>, int,
              imp2.app_event_cb, ffi.Pointer<ffi.Void>)>();
  ...
  int ui_app_remove_event_handler(
    imp2.app_event_handler_h event_handler,
  ) {
  ...
  late final _ui_app_remove_event_handlerPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(imp2.app_event_handler_h)>>(
          'ui_app_remove_event_handler');
  late final _ui_app_remove_event_handler = _ui_app_remove_event_handlerPtr
      .asFunction<int Function(imp2.app_event_handler_h)>();
...
typedef app_control_cbFunction = ffi.Void Function(
    imp1.app_control_h app_control, ffi.Pointer<ffi.Void> user_data);
/// @nodoc
