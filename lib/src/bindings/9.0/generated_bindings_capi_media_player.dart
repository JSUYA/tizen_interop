...
import 'generated_bindings_capi_media_sound_manager.dart' as imp2;
...
class Tizen90CapiMediaPlayer {
  ...
  int player_set_sound_stream_info(
    player_h player,
    imp2.sound_stream_info_h stream_info,
  ) {
  ...
  late final _player_set_sound_stream_infoPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(player_h,
              imp2.sound_stream_info_h)>>('player_set_sound_stream_info');
  late final _player_set_sound_stream_info = _player_set_sound_stream_infoPtr
      .asFunction<int Function(player_h, imp2.sound_stream_info_h)>();
  ...
  late final _player_set_media_packet_audio_frame_decoded_cb =
      _player_set_media_packet_audio_frame_decoded_cbPtr.asFunction<
          int Function(player_h, imp1.media_format_h, int,
  ...
  late final _player_push_media_streamPtr = _lookup<
          ffi.NativeFunction<ffi.Int Function(player_h, imp1.media_packet_h)>>(
      'player_push_media_stream');
  late final _player_push_media_stream = _player_push_media_streamPtr
      .asFunction<int Function(player_h, imp1.media_packet_h)>();
  ...
  late final _player_set_media_stream_infoPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(player_h, ffi.Int32,
              imp1.media_format_h)>>('player_set_media_stream_info');
  late final _player_set_media_stream_info = _player_set_media_stream_infoPtr
      .asFunction<int Function(player_h, int, imp1.media_format_h)>();
