...
class Tizen90MvImageClassification {
  ...
  late final _mv_image_classification_inferencePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_image_classification_h,
              imp1.mv_source_h)>>('mv_image_classification_inference');
  late final _mv_image_classification_inference =
      _mv_image_classification_inferencePtr.asFunction<
          int Function(mv_image_classification_h, imp1.mv_source_h)>();
  ...
  late final _mv_image_classification_inference_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_image_classification_h,
              imp1.mv_source_h)>>('mv_image_classification_inference_async');
