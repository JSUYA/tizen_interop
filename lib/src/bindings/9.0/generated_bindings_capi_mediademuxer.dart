...
class Tizen90CapiMediademuxer {
  ...
  int mediademuxer_get_track_info(
    mediademuxer_h demuxer,
    int track_index,
    ffi.Pointer<imp1.media_format_h> format,
  ) {
  ...
  late final _mediademuxer_get_track_infoPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  mediademuxer_h, ffi.Int, ffi.Pointer<imp1.media_format_h>)>>(
      'mediademuxer_get_track_info');
  late final _mediademuxer_get_track_info =
      _mediademuxer_get_track_infoPtr.asFunction<
          int Function(
              mediademuxer_h, int, ffi.Pointer<imp1.media_format_h>)>();
  ...
  int mediademuxer_read_sample(
    mediademuxer_h demuxer,
    int track_index,
    ffi.Pointer<imp1.media_packet_h> outbuf,
  ) {
  ...
  late final _mediademuxer_read_samplePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mediademuxer_h, ffi.Int,
              ffi.Pointer<imp1.media_packet_h>)>>('mediademuxer_read_sample');
  late final _mediademuxer_read_sample =
      _mediademuxer_read_samplePtr.asFunction<
          int Function(
              mediademuxer_h, int, ffi.Pointer<imp1.media_packet_h>)>();
