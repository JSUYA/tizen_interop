...
import 'generated_bindings_capi_ui_inputmethod.dart' as imp1;
...
class Tizen90Eom {
  ...
  int eom_set_output_window(
    int output_id,
    ffi.Pointer<imp1.Evas_Object> win,
  ) {
  ...
  late final _eom_set_output_windowPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(eom_output_id,
              ffi.Pointer<imp1.Evas_Object>)>>('eom_set_output_window');
  late final _eom_set_output_window = _eom_set_output_windowPtr
      .asFunction<int Function(int, ffi.Pointer<imp1.Evas_Object>)>();
}
