...
class Tizen90CapiMlService {
  ...
  late final _ml_service_requestPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ml_service_h, ffi.Pointer<ffi.Char>,
              imp1.ml_tensors_data_h)>>('ml_service_request');
  late final _ml_service_request = _ml_service_requestPtr.asFunction<
      int Function(
          ml_service_h, ffi.Pointer<ffi.Char>, imp1.ml_tensors_data_h)>();
  ...
  late final _ml_service_query_requestPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(ml_service_h, imp1.ml_tensors_data_h,
  ...
  late final _ml_service_query_request =
      _ml_service_query_requestPtr.asFunction<
          int Function(ml_service_h, imp1.ml_tensors_data_h,
              ffi.Pointer<imp1.ml_tensors_data_h>)>();
  ...
  int ml_service_model_get(
    ffi.Pointer<ffi.Char> name,
    int version,
    ffi.Pointer<imp1.ml_information_h> info,
  ) {
  ...
  late final _ml_service_model_getPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>, ffi.UnsignedInt,
              ffi.Pointer<imp1.ml_information_h>)>>('ml_service_model_get');
  late final _ml_service_model_get = _ml_service_model_getPtr.asFunction<
      int Function(
          ffi.Pointer<ffi.Char>, int, ffi.Pointer<imp1.ml_information_h>)>();
  ...
  late final _ml_service_model_get_activatedPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  ffi.Pointer<ffi.Char>, ffi.Pointer<imp1.ml_information_h>)>>(
  ...
  int ml_service_model_get_all(
    ffi.Pointer<ffi.Char> name,
    ffi.Pointer<imp1.ml_information_list_h> info_list,
  ) {
  ...
  late final _ml_service_model_get_allPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(ffi.Pointer<ffi.Char>,
                  ffi.Pointer<imp1.ml_information_list_h>)>>(
  ...
  int ml_service_resource_get(
    ffi.Pointer<ffi.Char> name,
    ffi.Pointer<imp1.ml_information_list_h> res,
  ) {
  ...
  late final _ml_service_resource_get = _ml_service_resource_getPtr.asFunction<
      int Function(
          ffi.Pointer<ffi.Char>, ffi.Pointer<imp1.ml_information_list_h>)>();
}
...
typedef ml_service_event_cbFunction = ffi.Void Function(ffi.Int32 event,
    imp1.ml_information_h event_data, ffi.Pointer<ffi.Void> user_data);
/// @nodoc
