...
class Tizen90CapiWebUrlDownload {
  ...
  late final _download_set_notification_app_controlPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Int, ffi.Int32,
              imp1.app_control_h)>>('download_set_notification_app_control');
  late final _download_set_notification_app_control =
      _download_set_notification_app_controlPtr
          .asFunction<int Function(int, int, imp1.app_control_h)>();
  ...
  int download_get_notification_app_control(
    int download_id,
    int type,
    ffi.Pointer<imp1.app_control_h> handle,
  ) {
