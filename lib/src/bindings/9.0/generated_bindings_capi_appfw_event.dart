...
class Tizen90CapiAppfwEvent {
  ...
  int event_publish_app_event(
    ffi.Pointer<ffi.Char> event_name,
    ffi.Pointer<imp1.bundle> event_data,
  ) {
  ...
  late final _event_publish_app_eventPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>,
              ffi.Pointer<imp1.bundle>)>>('event_publish_app_event');
  late final _event_publish_app_event = _event_publish_app_eventPtr.asFunction<
      int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<imp1.bundle>)>();
  ...
  late final _event_publish_trusted_app_eventPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ffi.Pointer<ffi.Char>,
              ffi.Pointer<imp1.bundle>)>>('event_publish_trusted_app_event');
...
typedef event_cbFunction = ffi.Void Function(ffi.Pointer<ffi.Char> event_name,
    ffi.Pointer<imp1.bundle> event_data, ffi.Pointer<ffi.Void> user_data);
/// @nodoc
