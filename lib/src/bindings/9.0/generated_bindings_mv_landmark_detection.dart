...
class Tizen90MvLandmarkDetection {
  ...
  late final _mv_facial_landmark_inferencePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_facial_landmark_h,
              imp1.mv_source_h)>>('mv_facial_landmark_inference');
  late final _mv_facial_landmark_inference = _mv_facial_landmark_inferencePtr
      .asFunction<int Function(mv_facial_landmark_h, imp1.mv_source_h)>();
  ...
  late final _mv_facial_landmark_inference_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_facial_landmark_h,
              imp1.mv_source_h)>>('mv_facial_landmark_inference_async');
  late final _mv_facial_landmark_inference_async =
      _mv_facial_landmark_inference_asyncPtr
          .asFunction<int Function(mv_facial_landmark_h, imp1.mv_source_h)>();
  ...
  late final _mv_pose_landmark_inferencePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_pose_landmark_h,
              imp1.mv_source_h)>>('mv_pose_landmark_inference');
  late final _mv_pose_landmark_inference = _mv_pose_landmark_inferencePtr
      .asFunction<int Function(mv_pose_landmark_h, imp1.mv_source_h)>();
  ...
  late final _mv_pose_landmark_inference_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mv_pose_landmark_h,
              imp1.mv_source_h)>>('mv_pose_landmark_inference_async');
  late final _mv_pose_landmark_inference_async =
      _mv_pose_landmark_inference_asyncPtr
          .asFunction<int Function(mv_pose_landmark_h, imp1.mv_source_h)>();
