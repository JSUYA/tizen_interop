...
class Tizen90MvBarcodeGenerator {
  ...
  late final _mv_barcode_generate_sourcePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Int32,
              ffi.Int,
              imp1.mv_source_h)>>('mv_barcode_generate_source');
  late final _mv_barcode_generate_source =
      _mv_barcode_generate_sourcePtr.asFunction<
          int Function(imp1.mv_engine_config_h, ffi.Pointer<ffi.Char>, int, int,
              int, int, imp1.mv_source_h)>();
  ...
  late final _mv_barcode_generate_image =
      _mv_barcode_generate_imagePtr.asFunction<
          int Function(imp1.mv_engine_config_h, ffi.Pointer<ffi.Char>, int, int,
              int, int, int, int, ffi.Pointer<ffi.Char>, int)>();
}
