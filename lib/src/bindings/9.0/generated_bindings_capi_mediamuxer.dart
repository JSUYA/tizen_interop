...
class Tizen90CapiMediamuxer {
  ...
  int mediamuxer_add_track(
    mediamuxer_h muxer,
    imp1.media_format_h media_format,
  ...
  late final _mediamuxer_add_trackPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mediamuxer_h, imp1.media_format_h,
              ffi.Pointer<ffi.Int>)>>('mediamuxer_add_track');
  late final _mediamuxer_add_track = _mediamuxer_add_trackPtr.asFunction<
      int Function(mediamuxer_h, imp1.media_format_h, ffi.Pointer<ffi.Int>)>();
  ...
  late final _mediamuxer_write_samplePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(mediamuxer_h, ffi.Int,
              imp1.media_packet_h)>>('mediamuxer_write_sample');
  late final _mediamuxer_write_sample = _mediamuxer_write_samplePtr
      .asFunction<int Function(mediamuxer_h, int, imp1.media_packet_h)>();
