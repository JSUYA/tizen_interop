...
class Tizen60MvBarcodeDetector {
  ...
  late final _mv_barcode_detect = _mv_barcode_detectPtr.asFunction<
      int Function(imp1.mv_source_h, imp1.mv_engine_config_h, mv_rectangle_s,
          mv_barcode_detected_cb, ffi.Pointer<ffi.Void>)>();
}
...
typedef mv_barcode_detected_cbFunction = ffi.Void Function(
    imp1.mv_source_h source,
    imp1.mv_engine_config_h engine_cfg,
    ffi.Pointer<mv_quadrangle_s> barcode_locations,
