...
import 'generated_bindings_capi_media_camera.dart' as imp1;
...
class Tizen60CapiMediaRecorder {
  ...
  late final _recorder_create_videorecorderPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(imp1.camera_h,
  ...
  late final _recorder_create_videorecorder = _recorder_create_videorecorderPtr
      .asFunction<int Function(imp1.camera_h, ffi.Pointer<recorder_h>)>();
  ...
  late final _recorder_set_sound_stream_infoPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(recorder_h,
              imp2.sound_stream_info_h)>>('recorder_set_sound_stream_info');
  late final _recorder_set_sound_stream_info =
      _recorder_set_sound_stream_infoPtr
          .asFunction<int Function(recorder_h, imp2.sound_stream_info_h)>();
