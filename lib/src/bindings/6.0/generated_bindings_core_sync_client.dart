...
import 'generated_bindings_accounts_svc.dart' as imp1;
import 'generated_bindings_bundle.dart' as imp2;
...
class Tizen60CoreSyncClient {
  ...
  late final _sync_manager_on_demand_sync_job =
      _sync_manager_on_demand_sync_jobPtr.asFunction<
          int Function(imp1.account_h, ffi.Pointer<ffi.Char>, int,
              ffi.Pointer<imp2.bundle>, ffi.Pointer<ffi.Int>)>();
  ...
  late final _sync_manager_add_periodic_sync_job =
      _sync_manager_add_periodic_sync_jobPtr.asFunction<
          int Function(imp1.account_h, ffi.Pointer<ffi.Char>, int, int,
              ffi.Pointer<imp2.bundle>, ffi.Pointer<ffi.Int>)>();
