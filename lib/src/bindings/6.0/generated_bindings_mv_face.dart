...
class Tizen60MvFace {
  ...
  late final _mv_face_recognition_model_add =
      _mv_face_recognition_model_addPtr.asFunction<
          int Function(imp1.mv_source_h, mv_face_recognition_model_h,
  ...
  late final _mv_face_recognition_model_learnPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(imp1.mv_engine_config_h,
  ...
  late final _mv_face_recognition_model_learn =
      _mv_face_recognition_model_learnPtr.asFunction<
          int Function(imp1.mv_engine_config_h, mv_face_recognition_model_h)>();
  ...
  late final _mv_face_tracking_model_prepare =
      _mv_face_tracking_model_preparePtr.asFunction<
          int Function(mv_face_tracking_model_h, imp1.mv_engine_config_h,
              imp1.mv_source_h, ffi.Pointer<mv_quadrangle_s>)>();
...
/// @nodoc
typedef mv_rectangle_s = imp1.mv_rectangle_s;
